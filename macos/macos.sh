#!/usr/bin/env bash
#https://github.com/samoshkin/dotfiles/blob/master/macos.sh
...
# Then go to System Preferences -> Security and Privacy. And enable "Run
# applications -> Allow from anywhere"
...
# disable display sleep to use an intermediate half-brightness state between
...
defaults write com.google.Chrome.canary PMPrintingExpandedStateForPrint2 -bool
true
...
defaults write com.apple.Safari WebKitDeveloperExtrasEnabledPreferenceKey -bool
true
defaults write com.apple.Safari
com.apple.Safari.ContentPageGroupIdentifier.WebKit2DeveloperExtrasEnabled -bool
true
